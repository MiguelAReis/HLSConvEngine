...
set id 1
set name depthwise_mul_mul_18s_6ns_18_4_1
...
set out_width 18
set exp i0*i1
set arg_lists {i0 {18 1 +} i1 {6 0 +} p {18 1 +} acc {0} }
set TrueReset 0
...
set id 2
set name depthwise_mac_muladd_18s_6ns_18ns_18_4_1
...
set out_width 18
set exp i0*i1+i2
set arg_lists {i0 {18 1 +} i1 {6 0 +} m {18 1 +} i2 {18 0 +} p {18 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
