...
set id 1
set name depthwise_mul_32s_32s_32_2_1
...
set id 3
set name depthwise_ama_addmuladd_18ns_2ns_18s_18ns_18_4_1
...
set out_width 18
set exp (i0+i1)*i2+i3
set arg_lists {i0 {18 0 +} i1 {2 0 +} s {18 1 +} i2 {18 1 +} m {18 1 +} i3 {18 0 +} p {18 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 4
set name depthwise_mul_mul_14s_14s_14_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set id 5
set name depthwise_ama_addmuladd_2ns_18ns_18s_18ns_18_4_1
set corename simcore_ama
set op ama
set stage_num 4
set max_latency -1
...
set out_width 18
set exp (i0+i1)*i2+i3
set arg_lists {i0 {2 0 +} i1 {18 0 +} s {18 1 +} i2 {18 1 +} m {18 1 +} i3 {18 0 +} p {18 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_ama] == "ap_gen_simcore_ama"} {
eval "ap_gen_simcore_ama { \
...
set id 6
set name depthwise_ama_addmuladd_14s_14ns_14s_14ns_14_4_1
set corename simcore_ama
set op ama
set stage_num 4
set max_latency -1
...
set out_width 14
set exp (i0+i1)*i2+i3
set arg_lists {i0 {14 1 +} i1 {14 0 +} s {14 1 +} i2 {14 1 +} m {14 1 +} i3 {14 0 +} p {14 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_ama] == "ap_gen_simcore_ama"} {
eval "ap_gen_simcore_ama { \
...
set id 7
set name depthwise_mac_muladd_4s_4s_8ns_8_4_1
...
set out_width 8
set exp i0*i1+i2
set arg_lists {i0 {4 1 +} i1 {4 1 +} m {8 1 +} i2 {8 0 +} p {8 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 15
set hasByteEnable 0
set MemName depthwise_filter_V
...
set ID 16
set hasByteEnable 0
set MemName depthwise_featureMap_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 4
set AddrRange 258048
set AddrWd 18
set impl_style auto
set TrueReset 0
set HasInitializer 0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { strm_in_TDATA { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { strm_in_TKEEP { I 4 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { strm_in_TSTRB { I 4 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_kernelSize \
    op interface \
    ports { kernelSize { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_mapSizeX \
    op interface \
    ports { mapSizeX { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_mapSizeY \
    op interface \
    ports { mapSizeY { I 32 vector } } \
} "
}
...
# RegSlice definition:
set ID 30
set RegSliceName depthwise_regslice_both
set RegSliceInstName depthwise_regslice_both_U
set CoreName ap_simcore_depthwise_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
