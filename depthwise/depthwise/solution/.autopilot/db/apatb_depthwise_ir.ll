; ModuleID = '/media/miguel/NewVolume/Linux/Thesis/Hardware/VitisHLS/HLSConvEngine/depthwise/depthwise/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_depthwise_ir(%"class.hls::stream"* %strm_in, %"class.hls::stream"* %strm_out, i32 %kernelN, i32 %kernelSize, i32 %mapSizeX, i32 %mapSizeY, i1 %relu) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_depthwise_hw(%"class.hls::stream"* %strm_in_copy, %"class.hls::stream"* %strm_out_copy, i32 %kernelN, i32 %kernelSize, i32 %mapSizeX, i32 %mapSizeY, i1 %relu)
...
declare void @apatb_depthwise_hw(%"class.hls::stream"*, %"class.hls::stream"*, i32, i32, i32, i32, i1)

define void @depthwise_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, i32, i32, i32, i32, i1) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @depthwise_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, i32 %2, i32 %3, i32 %4, i32 %5, i1 %6)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @depthwise_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, i32, i32, i32, i32, i1)
