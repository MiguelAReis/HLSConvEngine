...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("kernelN", 32, hls_in, 8, "ap_none", "in_data", 1),
	Port_Property("kernelSize", 32, hls_in, 9, "ap_none", "in_data", 1),
	Port_Property("mapSizeX", 32, hls_in, 10, "ap_none", "in_data", 1),
	Port_Property("mapSizeY", 32, hls_in, 11, "ap_none", "in_data", 1),
	Port_Property("relu", 1, hls_in, 12, "ap_none", "in_data", 1),
};
const char* HLS_Design_Meta::dut_name = "depthwise";
