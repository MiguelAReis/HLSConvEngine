...
extern "C" void depthwise(__cosim_sC__*, __cosim_sC__*, int, int, int, int, char);
extern "C" void apatb_depthwise_hw(volatile void * __xlx_apatb_param_strm_in, volatile void * __xlx_apatb_param_strm_out, int __xlx_apatb_param_kernelN, int __xlx_apatb_param_kernelSize, int __xlx_apatb_param_mapSizeX, int __xlx_apatb_param_mapSizeY, char __xlx_apatb_param_relu) {
  ...
  // DUT call
  depthwise(__xlx_strm_in_input_buffer, __xlx_strm_out_input_buffer, __xlx_apatb_param_kernelN, __xlx_apatb_param_kernelSize, __xlx_apatb_param_mapSizeX, __xlx_apatb_param_mapSizeY, __xlx_apatb_param_relu);
