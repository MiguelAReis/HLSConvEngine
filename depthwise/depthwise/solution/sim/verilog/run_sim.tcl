...
if {[file isfile depthwise.autotvin.dat]} {
	file delete -force depthwise.autotvin.dat
}

if {[file isfile depthwise.autotvout.dat]} {
	file delete -force depthwise.autotvout.dat
}
