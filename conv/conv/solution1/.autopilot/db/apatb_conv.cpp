...
// wrapc file define:
#define AUTOTB_TVIN_filterN "../tv/cdatafile/c.conv.autotvin_filterN.dat"
#define AUTOTB_TVOUT_filterN "../tv/cdatafile/c.conv.autotvout_filterN.dat"
// wrapc file define:
#define AUTOTB_TVIN_kernelN "../tv/cdatafile/c.conv.autotvin_kernelN.dat"
#define AUTOTB_TVOUT_kernelN "../tv/cdatafile/c.conv.autotvout_kernelN.dat"
// wrapc file define:
#define AUTOTB_TVIN_kernelSize "../tv/cdatafile/c.conv.autotvin_kernelSize.dat"
#define AUTOTB_TVOUT_kernelSize "../tv/cdatafile/c.conv.autotvout_kernelSize.dat"
// wrapc file define:
#define AUTOTB_TVIN_mapSizeX "../tv/cdatafile/c.conv.autotvin_mapSizeX.dat"
#define AUTOTB_TVOUT_mapSizeX "../tv/cdatafile/c.conv.autotvout_mapSizeX.dat"
// wrapc file define:
#define AUTOTB_TVIN_mapSizeY "../tv/cdatafile/c.conv.autotvin_mapSizeY.dat"
#define AUTOTB_TVOUT_mapSizeY "../tv/cdatafile/c.conv.autotvout_mapSizeY.dat"
// wrapc file define:
#define AUTOTB_TVIN_relu "../tv/cdatafile/c.conv.autotvin_relu.dat"
#define AUTOTB_TVOUT_relu "../tv/cdatafile/c.conv.autotvout_relu.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_filterN "../tv/rtldatafile/rtl.conv.autotvout_filterN.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_kernelN "../tv/rtldatafile/rtl.conv.autotvout_kernelN.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_kernelSize "../tv/rtldatafile/rtl.conv.autotvout_kernelSize.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_mapSizeX "../tv/rtldatafile/rtl.conv.autotvout_mapSizeX.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_mapSizeY "../tv/rtldatafile/rtl.conv.autotvout_mapSizeY.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_relu "../tv/rtldatafile/rtl.conv.autotvout_relu.dat"
...
string get_depth_list () {
  ...
  total_list << "{filterN " << filterN_depth << "}\n";
...
extern "C" void conv_hw_stub_wrapper(volatile void *, volatile void *, int, int, int, int, int, char);
...
//filterN
aesl_fh.touch(AUTOTB_TVIN_filterN);
aesl_fh.touch(AUTOTB_TVOUT_filterN);
//kernelN
...
// print filterN Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_filterN, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_filterN);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_filterN, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.filterN_depth);
...
conv_hw_stub_wrapper(__xlx_apatb_param_strm_in, __xlx_apatb_param_strm_out, __xlx_apatb_param_filterN, __xlx_apatb_param_kernelN, __xlx_apatb_param_kernelSize, __xlx_apatb_param_mapSizeX, __xlx_apatb_param_mapSizeY, __xlx_apatb_param_relu);
