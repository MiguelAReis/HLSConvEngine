...
# 4 "../Sources/conv/conv.cpp" 2
# 1 "../Sources/conv/convParameters.h" 1
# 5 "../Sources/conv/conv.cpp" 2
...
__attribute__((sdx_kernel("conv", 0))) void conv(hls::stream<axisStream> &strm_in,
...
#pragma HLS loop_tripcount min=5 max=5
 FilterLOOP:for(int f=0; f<32; f++){
#pragma HLS loop_tripcount min=2 max=2
 KernelYLOOP:for(int ky=0; ky<3; ky++){
